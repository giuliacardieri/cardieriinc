<template>
  <Hero title="Conheça nossa política de privacidade" :button="false"></Hero>
  <section class="main__section">
    <p>
      A Cardieri Inc se preocupa com a privacidade e segurança dos seus
      clientes. Por isso, nos comprometemos com a transparência do tratamento de
      seus dados pessoais. Essa página define como é feita a coleta, uso e
      transferência de pessoas que acessam nosso site.
    </p>
    <p>
      Ao utilizar nossos serviços, você aceita coletemos e usemos suas
    ...
    <p>
      Dessa forma, a CARDIERI INCORPORACOES E CONSTRUCOES LTDA, doravante
      denominada simplesmente como “Cardieri Inc”, inscrita no CNPJ/MF sob o nº
      12.296.580/0001-95, no papel de Controladora de Dados, obriga-se ao
      disposto na presente Política de Privacidade.
    </p>
  </section>
  <section class="main__section">
    <h2 class="h2--privacidade">
    ...
    <ul>
      ...
      <li>Número de telefone fixo ou telefone celular;</li>
    </ul>
    <h3>1.2. Dados pessoais coletados automaticamente</h3>
    <ul>
      <li>Endereço IP;</li>
      <li>
        Localização aproximada de acordo com base de dados de endereço IP;
      </li>
      <li>
        Histórico de acessos anteriores e comportamento do visitante através da
        ferramenta Google Analytics;
      </li>
    </ul>
  </section>
  <section class="main__section">
    <h2 class="h2--privacidade">2. Como coletamos os seus dados?</h2>
    <p>
      Nesse sentido, a coleta dos seus dados pessoais ocorre da seguinte forma:
    </p>
    <ul>
      <li>Ao acessar o site cardieri.com.br;</li>
      <li>Ao enviar uma dúvida pelos formulários de contato;</li>
      <li>Ao efetuar uma ligação ou mensagem via whatsapp para a empresa;</li>
      <li>Ao enviar um e-mail para a empresa;</li>
    </ul>
    ...
    <p>
      ...
      você autoriza a Cardieri Inc a tratar seus dados.
    </p>
    <p>
    ...
    <p>
      ...
      acima descrita, evidenciando o compromisso de transparência e boa-fé da
      Cardieri INC com seus clientes, seguindo as regulações legislativas
      pertinentes.
    </p>
    <p>
      Ao acessar o site da Cardieri Inc e fornecer seus dados pessoais, você
      está ciente e consentindo com as disposições desta Política de
      Privacidade, além de conhecer seus direitos e como exercê-los.
    </p>
    <p>
  ...
  <section class="main__section">
    <h2 class="h2--privacidade">3. Quais são os seus direitos?</h2>
    <p>
      A Cardieri Inc assegura a seus clientes seus direitos de titular previstos
      no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de
    ...
    <ul>
      ...
      <li>
        Corrigir seus dados, ao solicitar a edição, correção ou atualização
        destes.
      </li>
      <li>
      ...
      <li>
        ...
        dados cadastrais que a (nome empresarial simplificado) trata a seu
        respeito.
      </li>
      <li>
  ...
  <section class="main__section">
    ...
    <p>
      ...
      Cardieri Inc através dos seguintes meios disponíveis:
    </p>
    <ul>
      <li>
        E-mail:
        <a href="mailto:adm.cia@cardieri.com.br">adm.cia@cardieri.com.br</a>
      </li>
      <li>Site: <a href="http://cardieri.com.br">cardieri.com.br</a></li>
      <li>Telefone: +55 15 3232-8506</li>
      <li>Whatsapp: +55 15 99799-5166</li>
    </ul>
    <p>
  ...
  <section class="main__section">
    ...
    <p>
      Seus dados pessoais coletados pela Cardieri Inc serão utilizados e
      armazenados durante o tempo necessário para o retorno do contato via
      formulário ou para que as finalidades elencadas na presente Política de
    ...
    <p>
      ...
      entre você e a Cardieri Inc perdurar. Findado o período de armazenamento
      dos dados pessoais, estes serão excluídos de nossas bases de dados ou
      anonimizados, ressalvadas as hipóteses legalmente previstas no artigo 16
      lei geral de proteção de dados, a saber:
    </p>
    <ul>
      <li>
    ...
    <p>
      O armazenamento de dados coletados pela Cardieri Inc reflete o nosso
    ...
    <p>
      ...
      disso, também contamos com medidas de segurança apropriadas aos riscos e
  ...
  <section class="main__section">
    ...
    <ul>
      ...
      <li>
        A Cardieri Inc se compromete a adotar as melhores posturas para evitar
      ...
      <li>
        ...
        relevante para você ou qualquer um de nossos clientes, comunicaremos aos
  ...
  <section class="main__section">
    ...
    <p>
      Tendo em vista a preservação de sua privacidade, a Cardieri Inc não
      compartilhará seus dados pessoais com nenhum terceiro não autorizado.
    </p>
    <p>
      Seus dados poderão ser compartilhados diante de situações excepcionais,
      que são:
    </p>
    <ul>
      <li>
      ...
      <li>
        III – Proteção dos direitos da (nome empresarial simplificado) em
    ...
    <p>
      Nesse sentido, a Cardieri Inc se compromete a sempre adotar eficientes
  ...
  <section class="main__section">
    <h2 class="h2--privacidade">8. Cookies ou dados de navegação</h2>
    <p>
      A Cardieri Inc faz uso de Cookies, que são arquivos de texto enviados pela
    ...
    <p>
      Ao acessar nosso site você consente com o uso de Cookies, você manifesta
      conhecer e aceitar a utilização de um sistema de coleta de dados de
      navegação com o uso de Cookies em seu dispositivo.
    </p>
    <p>A Cardieri Inc utiliza os seguintes Cookies:</p>
    <ul>
      <li>
        Ferramenta Google Analytics que registra sua localização aproximada, seu
        sistema operacional, navegador, horário da visita ao site, páginas
        visitadas dentro do site;
      </li>
    </ul>
    <p>
  ...
  <section class="main__section">
    <h2 class="h2--privacidade">9. Alteração desta Política de Privacidade</h2>
    <p>
      A atual versão da Política de Privacidade foi formulada e atualizada pela
      última vez em: 10 de Agosto de 2021.
    </p>
    <p>
  ...
  <section class="main__section">
    <h2 class="h2--privacidade">10. Responsabilidade</h2>
    <p>
      A Cardieri Inc prevê a responsabilidade dos agentes que atuam nos
      processos de tratamento de dados, em conformidade com os artigos 42 ao 45
    ...
    <p>
      ...
      providências em relação ao tratamento de dados realizado pela Cardieri
      Inc, comprometemo-nos a segui-las.
    </p>
    ...
    <p>
      ...
      inteiramente livre de riscos. Nesse sentido, a Cardieri Inc não se
      responsabiliza por:
    </p>
    <ul>
      <li>
        ...
        nos responsabilizamos apenas pela segurança dos processos de tratamento
        de dados e do cumprimento das finalidades descritas no presente
      ...
      <li>
        ...
        comprovada conduta culposa ou deliberada da Cardieri Inc. Destacamos que
      ...
      <li>
        III – Inveracidade das informações inseridas pelo cliente nos registros
        necessários para a utilização dos serviços da Cardieri Inc; quaisquer
        consequências decorrentes de informações falsas ou inseridas de má-fé
        são de inteiramente responsabilidade do usuário/cliente.
      </li>
    </ul>
  </section>
  <section class="main__section">
    <h2 class="h2--privacidade">11. Encarregado de Proteção de Dados</h2>
    <p>
      A Cardieri Inc disponibiliza os seguintes meios para que você possa entrar
      em contato conosco para exercer seus direitos de titular:
    </p>
    <ul>
      <li>
        E-mail:
    ...
    <p>
      Caso tenha dúvidas sobre esta Política de Privacidade ou sobre os dados
      pessoais que tratamos, você pode entrar em contato com o nosso Encarregado
      de Proteção de Dados Pessoais:
    </p>
    <ul>
      <li>
        Giulia Cardieri -
        <a href="mailto:giulia.cardieri@gmail.com">giulia.cardieri@gmail.com</a>
      </li>
    </ul>
  </section>
</template>
